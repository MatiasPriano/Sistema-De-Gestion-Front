    ...
    return (
        <div className="space-y-2 flex flex-col items-center justify-center text-center">
            <button disabled type="button" 
                ...
                <svg aria-hidden="true" role="status" className="inline w-10 h-10 me-3 text-blue-900 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

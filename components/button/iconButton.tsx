...
export default function IconButton({
  ...
  let className: string =
    "rounded-md px-3 py-2 text-sm transition-colors duration-300 ease-in-out";
  if (style === "primary") {
    className +=
    ...
    className +=
      " bg-red disabled:bg-backgroundAccent text-darkTitle disabled:text-title shadow-md hover:shadow-lg hover:bg-redHover";
  } else {
    className +=
      " bg-transparent disabled:bg-backgroundAccent text-title hover:bg-selected";
  }

export default function ResourceCell({ name }: { name: string | undefined }) {
    ...
    return (
        <div className="flex items-center">
            {resourceDefined && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-2 flex-shrink-0 text-title">

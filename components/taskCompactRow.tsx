    ...
    return (
        <tr key={task.id} className={getCheckBoxClass(isChecked)} >
            ...
            <td className="w-20 overflow-hidden">
                <div className="line-clamp-1 text-sm mx-2">#{task.id}</div>
            </td>
            <td className="w-150 overflow-hidden">
                <div className="line-clamp-1 text-sm mx-2">{task.title}</div>
            </td>
            <td className="w-60 overflow-hidden">
                <div className="line-clamp-1 text-sm mx-2">{task.project}</div>
            </td>
            <td className="w-40 overflow-hidden">
                <div className="flex items-center">
                    ...
                    <div className="line-clamp-1 text-sm mx-2">{task.responsable}</div>
                </div>
...
function getStatusClass(status: string) {
    let className = 'text-sm text-gray-900 rounded-md px-5 mx-5 py-1 my-1'
    if (status === 'Abierta') {

function getInputClassName(
  ...
  let className =
    "block w-full pl-2 pr-2 rounded-md border border-border py-2 placeholder:text-placeholder hover:shadow-lg focus:shadow-lg sm:text-sm focus:outline-none";
  if (isDisabled) {

...
function getTextAreaClassName(
  ...
  let className =
    "block w-full pl-2 pr-2 rounded-md border border-border py-1.5 placeholder:text-placeholder hover:shadow-lg focus:shadow-lg transition-colors duration-300 ease-in-out focus:outline-none";
  if (isDisabled) {
    ...
    <div className="space-y-2">
      ...
      <div>
        <textarea
          ...
          disabled={disabled}
        />
        <small className={getSubtextClassName(isObligatory, error)}>

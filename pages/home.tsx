          ...
          <div className="flex justify-center py-5">
            <div className="bg-gray-50 max-w-sm p-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 
              ...
              <div className="flex items-center">  
                ...
                <br/>
                <Link href="/projects" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-950 hover:bg-blue-800 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                      Ingresar al módulo
                </Link>
            ...
            <div className="bg-gray-50 max-w-sm p-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 
              ...
              <div className="flex items-center">
                ...
                <Link href="/products" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-950 hover:bg-blue-800 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                      Ingresar al módulo
                </Link>
            </div>
          </div>

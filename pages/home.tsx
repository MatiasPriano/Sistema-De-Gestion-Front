		...
		<div className="flex flex-col sm:flex-row items-center justify-center py-5">
			<div className="bg-backgroundAccent max-w-sm p-6 border border-border shadow-md hover:shadow-lg rounded-lg shadow w-full m-5 h-52 w-80">
				<div className="flex items-center">  
					...
					<h5 className="text-xl sm:text-2xl font-bold tracking-tight text-textColor p-2 text-title">Proyectos</h5>
				</div>
			...
			<div className="bg-backgroundAccent max-w-sm p-6 border border-border shadow-md hover:shadow-lg rounded-lg shadow w-full m-5 h-52 w-80">
				<div className="flex items-center">
					<img src="https://img.icons8.com/?size=100&id=11683&format=png&color=000000" className="h-7 w-7 text-title"></img> 
					<h5 className="text-xl sm:text-2xl font-bold tracking-tight text-title p-2">Soporte</h5>
				</div>
				<p className="mb-3 font-normal text-subtitle">Módulo para la gestión de tickets</p>
				<br/>
